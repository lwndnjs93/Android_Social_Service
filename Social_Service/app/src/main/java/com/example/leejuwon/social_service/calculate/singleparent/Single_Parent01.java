...
public class Single_Parent01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single__parent01);
        ...
        if (getIntent().getExtras() != null) {
            email = getIntent();
            Semail = email.getExtras().getString("01"); //Calculate에서 넘어온 이메일을 받는다
            Log.i("한부모가정 지원 모의계산", Semail);
            try {
                ...
                age = result.substring(a24 + 3, a25);
                Log.d("가구주 연령", age);
        ...
        //가구주 연령 고르는 박스
        final Button bt01 = (Button) findViewById(R.id.age01);
                ...
                alertDialogBuilder.setItems(items,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                //프로그램을 종료한다
                                dialog.dismiss();
                                Button bt01 = (Button) findViewById(R.id.age01);
                                bt01.setText(items[id]);
                                switch (id) {
                                    case 0:
        ...
        //도시 고르기 박스 시작
        Button bt02 = (Button) findViewById(R.id.abode01);
        ...
        bt03.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Button age00 = (Button) findViewById(R.id.age01);
                if (age00.getText().equals("가구주연령")) {
                    age = "0";
                }
                ...
                intent = new Intent(Single_Parent01.this, Single_Parent01_01.class);
                ...
                intent.putExtra("16", age); //가구주 연령
                intent.putExtra("17", city); //도시 고르기
